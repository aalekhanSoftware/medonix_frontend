...
export class SaleComponent implements OnInit, OnDestroy {
  ...
  totalPages = 0;
  totalElements = 0;
  totalSalesAmountSum: number | null = null;
  startIndex = 0;
  endIndex = 0;
  customers: any[] = [];
  ...
  private calculateTotalSalesAmount(rows: Sale[]): number {
    let sum = 0;
    ...
    this.saleService.searchSales(params)
      ...
      .subscribe({
        next: (response: any) => {
          ...
          this.totalSalesAmountSum = this.calculateTotalSalesAmount(this.sales);
